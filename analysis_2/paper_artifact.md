...
[Coded Diffusion Research Boundary](research_boundary.md), not a new
runtime contract.
...
reproducible active-belief report PDF is generated by `just active-belief-report`
under `artifacts/analysis_2/latest/active-belief-report.pdf`, and the
documentation manuscript is checked through `just book`. Venue-specific
