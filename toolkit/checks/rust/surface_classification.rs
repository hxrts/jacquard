...
fn check_trait(trait_item: &syn::ItemTrait, rel_path: &str, violations: &mut Vec<Violation>) {
    ...
    if !doc_text.contains("connectivity surface") && !doc_text.contains("service surface") {
