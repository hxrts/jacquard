...
lean_lib JacquardVerification where
  roots := #[
    ...
    `Field.ActiveBeliefDefinitive,
    `Field.ActiveBeliefDefinitiveClosure,
    `Field.ActiveBeliefPhase6,
    `Field.ActiveBeliefCertificates,
    `Field.ActiveBeliefEndToEnd,
    `Field.ActiveBeliefDecisionSufficiency,
