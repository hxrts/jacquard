//! Centralized permitted style-guide exemptions (mock infrastructure, tests, documented exceptions).
...
pub const STYLE_GUIDE_EXCEPTIONS: &[(&str, &str)] = &[
    ("jacquard_mesh::routing_invariants::run", "long-block-exception: rule coordination workflow"),
...
pub const OWNERSHIP_PERMITS: &[(&str, &str)] = &[
    ("mem-link-profile-test-only", "work/_impl.md#mem-link-profile-test-infrastructure"),
];
