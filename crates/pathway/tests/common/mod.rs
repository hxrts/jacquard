//! Shared fixtures and helpers for the pathway integration tests.
//!
...
/// Standard "local" node used in most pathway integration tests.
pub const LOCAL_NODE_ID: NodeId = NodeId([1; 32]);
/// Standard peer node used in most pathway integration tests.
pub const PEER_NODE_ID: NodeId = NodeId([2; 32]);
/// Standard far node used in most pathway integration tests.
pub const FAR_NODE_ID: NodeId = NodeId([3; 32]);
/// Standard bridge node used in most pathway integration tests.
pub const BRIDGE_NODE_ID: NodeId = NodeId([4; 32]);
/// Standard discovery scope used in most pathway integration tests.
