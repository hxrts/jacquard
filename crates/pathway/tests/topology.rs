...
struct PreferredPeerTopologyModel {
    base: DeterministicPathwayTopologyModel,
...
impl PreferredPeerTopologyModel {
    fn new(preferred_peer: NodeId) -> Self {
        Self {
            base: DeterministicPathwayTopologyModel::new(),
            preferred_peer,
        }
    }
}

impl PathwayTopologyModel for PreferredPeerTopologyModel {
...
type PreferredEngine = PathwayEngine<
...
fn build_preferred_engine(preferred_peer: NodeId) -> PreferredEngine {
    PathwayEngine::without_committee_selector(
        LOCAL_NODE_ID,
