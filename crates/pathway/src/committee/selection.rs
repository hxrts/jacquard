...
pub struct DeterministicCommitteeSelector<
    Topology = DeterministicPathwayTopologyModel,
...
> {
    ...
    pub hashing: Hasher,
    behavior_history: BTreeMap<NodeId, PathwayBehaviorHistory>,
}
...
impl<Topology> DeterministicCommitteeSelector<Topology, Blake3Hashing> {
    ...
    pub fn with_topology_model(
        ...
        Self {
            ...
            membership_cap: PATHWAY_COMMITTEE_MEMBERSHIP_CAP,
            topology_model,
    ...
    Hasher::Digest: HashDigestBytes,
{
    ...
    fn committee_selection(
        ...
        let validity_end = Tick(
            current_tick
                .0
                .saturating_add(PATHWAY_COMMITTEE_VALIDITY_TICKS),
        );
        CommitteeSelection {
