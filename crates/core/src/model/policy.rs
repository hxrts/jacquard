...
/// The adaptive controller may move route protection from target toward floor
...
#[public_model]
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
/// Abstract protection level that a route family may provide.
...
#[public_model]
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
/// Abstract connectivity profile that a route family may provide.
