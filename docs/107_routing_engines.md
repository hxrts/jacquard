...
This page describes the trait surface for adding a routing algorithm to Jacquard. See [World Extensions](106_world_extensions.md) for the layering overview, [Runtime Effects](108_runtime_effects.md) for the host capability surface, and [Mesh Routing](109_mesh_routing.md) for the in-tree mesh implementation and its swappable subcomponents.
