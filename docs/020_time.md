...
See [Core Types](010_core_types.md) for the shared model objects that use these domains. See [Routing Architecture](030_routing_architecture.md) for the runtime layers that consume them.
