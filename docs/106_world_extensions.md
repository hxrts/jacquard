...
This page covers the world layer. See [Routing Engines](107_routing_engines.md) for the engine and policy contracts, [Runtime Effects](108_runtime_effects.md) for the host capability surface, and [Mesh Routing](109_mesh_routing.md) for the in-tree mesh implementation and its swappable subcomponents.
