...
`jacquard-simulator` tracks the workspace version `0.7.1`. Add it alongside the core and trait crates a consumer typically imports types from.

```toml
[dependencies]
jacquard-simulator = "0.7.1"
jacquard-core = "0.7.1"
