...
def cleanup_report_dir(report_dir: Path) -> None:
    for name in [
        ...
        "scatter_family_route_presence.png",
        "scatter_family_stability.png",
        ...
        "head_to_head_timing_profile.png",
        "recommended_engine_robustness.png",
        "mixed_vs_standalone_divergence.png",
        "diffusion_delivery_coverage.png",
        "diffusion_resource_boundedness.png",
        "large_population_route_scaling.png",
        "large_population_route_fragility.png",
        "large_population_diffusion_transitions.png",
        "routing_fitness_crossover.png",
        "routing_fitness_multiflow.png",
        "routing_fitness_stale_repair.png",
        "report.pdf",
        "tuning_report.pdf",
